...
//	private JPanel pnlInput_data;
	...
	public AirControl () {
		...
		lblAngle_input = new JLabel("�ngulo:");
		...
		lblDiretion_input = new JLabel("Dire��o:");
		...
		lblFunc_Trans = new JLabel("Fun��es de Transforma��o");
		...
		lblAngle_rotate = new JLabel("�ngulo:");
		...
		lblrotate_center = new JLabel("Centro Rota��o");
		...
		//Tracking function
		lblTrackFunction = new JLabel("Fun��es de Rastreamento");
		lblTrackFunction.setBounds(90, 400, 150, 25);
		getContentPane().add(lblTrackFunction);
		
		lblDistance_track = new JLabel("Dist�ncia M�nima:");
		...
		lblDistanceMin_track = new JLabel("Dist�ncia M�nima:");
		...
		lblTime_track = new JLabel("Tempo M�nimo:");
		...
		btncolisionroute = new JButton("Em rota de colis�o");
		btncolisionroute.setBounds(440, 460, 120, 25);
		getContentPane().add(btncolisionroute);
		
		lblRelatory = new JLabel("Relat�rio");
